...
// Problem-4 : No. of subarrays with exactly k distinct elements
public class Solution
{
    public static void exactlyKDistinct(int[] nums, int k) {
        System.out.println(atmostKDistinct(nums, k) -  atmostKDistinct(nums, k - 1));
    }
